...
export const ShaderBackground: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fsSource = `
      ...
      void main() {
        ...
        // Dark midnight base background #10131b
        vec3 color = vec3(0.062, 0.074, 0.105);
  ...
  return (
    <div className="fixed inset-0 w-full h-full -z-50 pointer-events-none overflow-hidden bg-[#10131b]">
